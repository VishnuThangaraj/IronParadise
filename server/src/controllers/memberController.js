...
const makePayment = async (req, res) => {
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              <h2>Hello, ${existingMember.name}!</h2>
              <p>We hope you're enjoying your journey with Iron Paradise!</p>
              <p>Your payment for the subscription plan has been received.</p>
              <p>Amount Paid: <strong>₹${payment.amount}</strong></p>
              <p>Pending Amount: <strong>${payment.dueAmount}</strong></p><p>Payment Mode : <strong>₹${payment.paymentMethod}</strong></p>
              <br/>
              <p>Plan Name : ${paymentHistClear.subscription.name}</p>
              <p>Plan Duration : ${paymentHistClear.subscription.duration} Months</p>
...
`;
    ...
    sendMail(
      ...
      "IronParadise Subscription Payment Received",
      html
    );
