...
const sidebarGeneral = [
  ...
  { name: "Events", location: "event", icon: "fa-light fa-calendars" },
];
...
export const Sidebar = () => {
  ...
  return (
    <div
      id="sidebar"
      className="bg-black py-6 rounded-tr-3xl rounded-br-3xl px-5 flex flex-col justify-between"
    >
      <div>
      ...
      <div
        className="text-gray-300 cursor-pointer transition-all duration-300 hover:text-gray-100"
        onClick={() => setOpen(true)}
      >
        <i className="fa-solid fa-arrow-left-from-bracket me-3"></i>
        Logout
      </div>
